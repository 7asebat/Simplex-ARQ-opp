...
EventDescriptor::EventDescriptor() : omnetpp::cClassDescriptor("Event", "")
{
...
int EventDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *EventDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string EventDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool EventDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *EventDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("Message_Type");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("Message_Type"));
    e->insert(DATA, "DATA");
    e->insert(ACK, "ACK");
    e->insert(NACK, "NACK");
)
...
{
    doParsimPacking(b,a.message_id);
    doParsimPacking(b,a.sending_time);
    doParsimPacking(b,a.message_type);
}

void __doUnpacking(omnetpp::cCommBuffer *b, Header& a)
{
    doParsimUnpacking(b,a.message_id);
    doParsimUnpacking(b,a.sending_time);
    doParsimUnpacking(b,a.message_type);
}
...
HeaderDescriptor::HeaderDescriptor() : omnetpp::cClassDescriptor("Header", "")
{
    propertynames = nullptr;
}
...
int HeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "message_type")==0) return base+2;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
const char *HeaderDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "Message_Type";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string HeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Header *pp = (Header *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->message_id);
        case 1: return double2string(pp->sending_time);
        case 2: return enum2string(pp->message_type, "Message_Type");
        default: return "";
    }
}
...
bool HeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Header *pp = (Header *)object; (void)pp;
    switch (field) {
        case 0: pp->message_id = string2ulong(value); return true;
        case 1: pp->sending_time = string2double(value); return true;
        case 2: pp->message_type = (Message_Type)string2enum(value, "Message_Type"); return true;
        default: return false;
    }
}
...
{
    doParsimPacking(b,a.header);
    doParsimPacking(b,a.payload);
    doParsimPacking(b,a.trailer);
}

void __doUnpacking(omnetpp::cCommBuffer *b, Frame& a)
{
    doParsimUnpacking(b,a.header);
    doParsimUnpacking(b,a.payload);
    doParsimUnpacking(b,a.trailer);
}
...
FrameDescriptor::FrameDescriptor() : omnetpp::cClassDescriptor("Frame", "")
{
    propertynames = nullptr;
}
...
Register_Class(Message_Event)

Message_Event::Message_Event(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}

Message_Event::Message_Event(const Message_Event& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
Message_Event& Message_Event::operator=(const Message_Event& other)
{
...
void Message_Event::copy(const Message_Event& other)
{
    this->event = other.event;
}

void Message_Event::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->event);
}

void Message_Event::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->event);
}

Event& Message_Event::getEvent()
{
    return this->event;
}

void Message_Event::setEvent(const Event& event)
{
    this->event = event;
}

class Message_EventDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
  public:
    Message_EventDescriptor();
    virtual ~Message_EventDescriptor();
...
Register_ClassDescriptor(Message_EventDescriptor)

Message_EventDescriptor::Message_EventDescriptor() : omnetpp::cClassDescriptor("Message_Event", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

Message_EventDescriptor::~Message_EventDescriptor()
{
    delete[] propertynames;
}

bool Message_EventDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Message_Event *>(obj)!=nullptr;
}

const char **Message_EventDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *Message_EventDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int Message_EventDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int Message_EventDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_EventDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int Message_EventDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0]=='e' && strcmp(fieldName, "event")==0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *Message_EventDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **Message_EventDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_EventDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int Message_EventDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Message_Event *pp = (Message_Event *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *Message_EventDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string Message_EventDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Message_Event *pp = (Message_Event *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getEvent(); return out.str();}
        default: return "";
    }
}

bool Message_EventDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_EventDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(Event));
        default: return nullptr;
    };
}

void *Message_EventDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Message_Event *pp = (Message_Event *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getEvent()); break;
        default: return nullptr;
    }
}

Register_Class(Message_Frame)

Message_Frame::Message_Frame(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}

Message_Frame::Message_Frame(const Message_Frame& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
Message_Frame& Message_Frame::operator=(const Message_Frame& other)
{
    if (this==&other) return *this;
    ::omnetpp::cPacket::operator=(other);
    copy(other);
...
void Message_Frame::copy(const Message_Frame& other)
{
    this->frame = other.frame;
}

void Message_Frame::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->frame);
}

void Message_Frame::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->frame);
}

Frame& Message_Frame::getFrame()
{
    return this->frame;
}

void Message_Frame::setFrame(const Frame& frame)
{
    this->frame = frame;
}

class Message_FrameDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
  public:
    Message_FrameDescriptor();
    virtual ~Message_FrameDescriptor();
...
Register_ClassDescriptor(Message_FrameDescriptor)

Message_FrameDescriptor::Message_FrameDescriptor() : omnetpp::cClassDescriptor("Message_Frame", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

Message_FrameDescriptor::~Message_FrameDescriptor()
{
    delete[] propertynames;
}

bool Message_FrameDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Message_Frame *>(obj)!=nullptr;
}

const char **Message_FrameDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *Message_FrameDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int Message_FrameDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int Message_FrameDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_FrameDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int Message_FrameDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
...
const char *Message_FrameDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **Message_FrameDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_FrameDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int Message_FrameDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Message_Frame *pp = (Message_Frame *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *Message_FrameDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string Message_FrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool Message_FrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_FrameDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *Message_FrameDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
